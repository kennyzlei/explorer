...
import OfferCreateMock from './mock_data/OfferCreateWithExpirationAndCancel.json'
...
describe('OfferCreate: Description', () => {
  it('renders description for transaction with cancel and expiration', () => {
    const wrapper = createWrapper(
      OfferCreateMock as TxResponseWithMeta<OfferCreate>,
    )
  ...
  it('renders description for transaction with inverted currencies', () => {
    const wrapper = createWrapper(
      OfferCreateInvertedCurrencies as TxResponseWithMeta<OfferCreate>,
    )
