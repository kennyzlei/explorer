...
describe('Payment: Description', () => {
  it('renders', () => {
    ...
    expect(wrapper.find('[data-test="source-tag-line"]')).not.toExist()
    expect(wrapper.find('[data-test="destination-tag-line"]')).not.toExist()
    expect(wrapper.find('[data-test="amount-line"]')).toHaveText(
      `It was instructed to deliver \uE9002,421.8268 XRP`,
    )
    expect(wrapper.find('[data-test="delivered-line"]')).toHaveText(
  ...
  it('renders with failed partial conversion', () => {
    ...
    expect(wrapper.find('[data-test="delivered-line"]')).not.toExist()
  ...
  it('renders with destination tag', () => {
    ...
    expect(wrapper.find('[data-test="source-tag-line"]')).not.toExist()
    expect(wrapper.find('[data-test="destination-tag-line"]')).toHaveText(
